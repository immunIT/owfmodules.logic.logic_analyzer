...
description = 'Collect samples on 8 GPIO channels for analysis in pulseview'
name = 'owfmodules.logic.logic_analyzer'
...
setup(
    ...
    keywords=['octowire', 'framework', 'hardware', 'security', 'analyzer', 'logic', 'sample']
)